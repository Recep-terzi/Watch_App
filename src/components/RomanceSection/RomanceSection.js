...
const RomanceSection = () => {
  ...
  useEffect(() => {
    axios
      .get(
        "https://api.themoviedb.org/3/discover/movie?api_key=466279f06d7f82ea9024d440431f8663&with_genres=10749"
      )
  ...
  return (
    <div className="film-section" id="film-section">
      <div className="container">
        <div className="film-section-title">Romantik Filmler</div>
      </div>
